...
if __name__ == "__main__":
    '''msalign_file_dir = r"Z:\I\Mapping the Proteoform Landscape of Five Human Tissues\heart\20210215_kjb9186_HuBMAP_CESI_Heart_biorep01_frac01_01_ms2.msalign"
    mzml_file_dir = r"Z:\I\Mapping the Proteoform Landscape of Five Human Tissues\heart\20210215_kjb9186_HuBMAP_CESI_Heart_biorep01_frac01_01.mzML"
    workplace_dir = r"Z:\I\Mapping the Proteoform Landscape of Five Human Tissues\heart\20210215_kjb9186_HuBMAP_CESI_Heart_biorep01_frac01_01_html\toppic_prsm_cutoff\data_js\prsms"
    prsm_dir = r"Z:\I\Mapping the Proteoform Landscape of Five Human Tissues\heart\20210215_kjb9186_HuBMAP_CESI_Heart_biorep01_frac01_01_html\toppic_prsm_cutoff\data_js\prsms"'''
    base_dir = r"Z:\I\EnvCNN_Publish_Data\Ovarian_Tumor_Data\raw"
    mzml_file_dir = os.path.join(
        base_dir, "CPTAC_Intact_rep2_15Jan15_Bane_C2-14-08-02RZ.mzML"
    )
    msalign_file_dir = os.path.join(
        base_dir, "CPTAC_Intact_rep2_15Jan15_Bane_C2-14-08-02RZ_ms2.msalign"
    )
    prsm_dir = os.path.join(
        base_dir,
        r"CPTAC_Intact_rep2_15Jan15_Bane_C2-14-08-02RZ_html\toppic_prsm_cutoff\data_js\prsms",
    )
